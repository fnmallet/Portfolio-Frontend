...
const switchTheme = () => {
    ...
    if (darkMode) {
        ...
        (_a = document.getElementById("logoArgPrograma")) === null || _a === void 0 ? void 0 : _a.setAttribute("src", urlLogoArgProgramaLight);
        (_b = document.getElementById("buttonThemeImg")) === null || _b === void 0 ? void 0 : _b.setAttribute("src", urlButtonThemeLight);
        darkMode = false;
    }
    else {
        ...
        (_c = document.getElementById("logoArgPrograma")) === null || _c === void 0 ? void 0 : _c.setAttribute("src", urlLogoArgProgramaDark);
        (_d = document.getElementById("buttonThemeImg")) === null || _d === void 0 ? void 0 : _d.setAttribute("src", urlButtonThemeDark);
        darkMode = true;
    }
};
const switchElementsClass = (oldClass, newClass) => {
...
const switchClass = (element, oldClass, newClass) => {
